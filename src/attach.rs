...
use crate::rig::{PlayerRig, JointId, Transform};
...
impl Attachment {
    pub fn rigid(joint: JointId) -> Self {
        Self { joint, offset_pos: Vec3::ZERO, offset_rot: Quat::IDENTITY, rigid: true }
    }

    pub fn with_offset(joint: JointId, offset_pos: Vec3, offset_rot: Quat) -> Self {
        Self { joint, offset_pos, offset_rot, rigid: false }
    }
