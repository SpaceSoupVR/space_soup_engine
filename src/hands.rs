...
use crate::scene::{GameObject, CuboidDef, Color3, CuboidStyle};
use crate::rig::{JointId, FingerJoint};
...
fn joint_half_size(joint: FingerJoint) -> Vec3 {
    match joint {
        ...
        FingerJoint::ThumbMeta | FingerJoint::IndexMeta | FingerJoint::MiddleMeta
        | FingerJoint::RingMeta | FingerJoint::LittleMeta => Vec3::new(0.009, 0.009, 0.014),
        FingerJoint::ThumbTip | FingerJoint::IndexTip | FingerJoint::MiddleTip
        | FingerJoint::RingTip | FingerJoint::LittleTip => Vec3::new(0.006, 0.006, 0.008),
...
pub fn spawn_hand_rig(runtime: &mut GameRuntime, hand: Hand) {
    let prefix = match hand { Hand::Left => "lhand", Hand::Right => "rhand" };
    ...
    for joint in FingerJoint::ALL {
        ...
        runtime.attachments.attach(&id, Attachment::rigid(JointId::Finger(hand, joint)));
    }
